...
struct ThemeLight: ThemeStyle {
    ...
    var secondatyAccentColor1:Color = Color(red: 95 / 255, green: 84 / 255, blue: 143 / 255)
    var secondatyAccentColor2:Color = Color(red: 234 / 255, green: 144 / 255, blue: 59 / 255)
    var secondatyAccentColor3:Color = Color(red: 58 / 255, green: 111 / 255, blue: 67 / 255)
    var secondatyAccentColor4:Color = Color(red: 44 / 255, green: 97 / 255, blue: 159 / 255)
