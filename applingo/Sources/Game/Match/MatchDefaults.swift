...
internal let MATCH_SCORE_QUICK_BONUS = 8
...
internal let MATCH_CORRECT_FEEDBACK_DURATION: TimeInterval = 0.1

/// The incorrect feedback duration.
internal let MATCH_INCORRECT_FEEDBACK_DURATION: TimeInterval = 0.5
